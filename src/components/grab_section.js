...
const Grab = (props) => {
  ...
  useEffect(() => {
    ...
    tl.fromTo(
      '.Grab-grab_img_phone_background-46',
      {
        x: 0
      },
      {
        ...
        duration: 1,
        scrollTrigger: {
          trigger: ".Grab-grab_img_phone_src-45",
          start: "center bottom",
          end: "center top",
          scrub: true,
        }
    ...
    tl.to(
      '.Grab-social_contact_detail-51',
      {
        left: 100,
        opacity: 1,
        duration: 0.1,
        scrollTrigger: {
          trigger: ".Grab-social_contact_form-47",
          start: "center bottom",
          end: "center center",
          scrub: true,
        }
    ...
    tl.to(
      '.Grab-social_contact_twitter-54',
      {
        left: 150,
        opacity: 1,
        duration: 0.2,
    ...
    tl.to(
      '.Grab-social_contact_instagram-53',
      {
        left: 75,
        opacity: 1,
        duration: 0.2,
